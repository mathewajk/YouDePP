...
df.fischers.hc.observed <- data.frame(read.table("../dependencies/ja/Fischers_handcorrected/Fischers_handcorrected_observed_dependencies.csv",
                                                  header=TRUE, sep=","))
df.fischers.hc.optimal  <- data.frame(read.table("../dependencies/ja/Fischers_handcorrected/Fischers_handcorrected_optimal_dependencies.csv",
                                                  header=TRUE, sep=","))
df.fischers.hc.random   <- data.frame(read.table("../dependencies/ja/Fischers_handcorrected/Fischers_handcorrected_random_dependencies.csv", 
                                                  header=TRUE, sep=","))
