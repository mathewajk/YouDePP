...
df.ja.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ja/ja_gsd_observed_dependencies.csv",
             header=TRUE, sep=","))
df.ja.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ja/ja_gsd_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.ja.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ja/ja_gsd_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.ja <- bind_rows(list("Observed"=df.ja.observed, "Optimal"=df.ja.optimal,
                           "Random"=df.ja.random),  .id = 'baseline')

df.ru.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ru/ru_syntagrus_observed_dependencies.csv",
             header=TRUE, sep=","))
df.ru.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ru/ru_syntagrus_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.ru.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ru/ru_syntagrus_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.ru <- bind_rows(list("Observed"=df.ru.observed, "Optimal"=df.ru.optimal,
                           "Random"=df.ru.random),  .id = 'baseline')


df.ar.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ar/ar_nyuad_observed_dependencies.csv",
             header=TRUE, sep=","))
df.ar.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ar/ar_nyuad_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.ar.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ar/ar_nyuad_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.ar <- bind_rows(list("Observed"=df.ar.observed, "Optimal"=df.ar.optimal,
                           "Random"=df.ar.random),  .id = 'baseline')


df.ko.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ko/ko_gsd_observed_dependencies.csv",
             header=TRUE, sep=","))
df.ko.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ko/ko_gsd_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.ko.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/ko/ko_gsd_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.ko <- bind_rows(list("Observed"=df.ko.observed, "Optimal"=df.ko.optimal,
                           "Random"=df.ko.random),  .id = 'baseline')


df.fr.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/fr/fr_gsd_observed_dependencies.csv",
             header=TRUE, sep=","))
df.fr.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/fr/fr_gsd_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.fr.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/fr/fr_gsd_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.fr <- bind_rows(list("Observed"=df.fr.observed, "Optimal"=df.fr.optimal,
                           "Random"=df.fr.random),  .id = 'baseline')


df.it.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/it/it_isdt_observed_dependencies.csv",
             header=TRUE, sep=","))
df.it.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/it/it_isdt_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.it.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/it/it_isdt_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.it <- bind_rows(list("Observed"=df.it.observed, "Optimal"=df.it.optimal,
                           "Random"=df.it.random),  .id = 'baseline')

df.tr.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/tr/tr_imst_observed_dependencies.csv",
             header=TRUE, sep=","))
df.tr.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/tr/tr_imst_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.tr.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/tr/tr_imst_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.tr <- bind_rows(list("Observed"=df.tr.observed, "Optimal"=df.tr.optimal,
                           "Random"=df.tr.random),  .id = 'baseline')

df.en.observed <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/en/en_ewt_observed_dependencies.csv",
             header=TRUE, sep=","))
df.en.optimal  <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/en/en_ewt_optimal_dependencies.csv",  
             header=TRUE, sep=","))
df.en.random   <- data.frame(
  read.table("D:/git-projects/YouDePP/corpus/dependency_counts/ud/en/en_ewt_random_dependencies.csv",
             header=TRUE, sep=","))

df.all.en <- bind_rows(list("Observed"=df.en.observed, "Optimal"=df.en.optimal,
...
df.all <- bind_rows(list("Japanese"=df.all.ja, "Russian"=df.all.ru, "Italian"=df.all.it, "Korean"=df.all.ko, "Turkish"=df.all.tr, "English"=df.all.en, "French"=df.all.fr), .id="language")

df.all$sent_len_sq <- df.all$total_length * df.all$total_length

df.all$baseline =  factor(df.all$baseline)
...
all.dependencies <- ggplot(df.all.avg %>% filter(total_length <= 20), aes(y=avg_length, x=total_length, color=baseline, group=baseline)) +
    stat_bin_hex(data=df.all.observed %>% filter(total_length <= 20), bins=30, show.legend=FALSE, inherit.aes=FALSE,
